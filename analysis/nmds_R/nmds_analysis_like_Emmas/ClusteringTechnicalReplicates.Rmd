...
ggplot(pca_meta, aes(PC1, PC2)) + geom_point(aes(col = day, shape = temp)) + theme_bw() + ggtitle("ADJNSAF values with zeros replaced with 0.1")
```
...
ggplot(pca_log_meta, aes(PC1, PC2)) + geom_point(aes(col = day, shape = temp)) + theme_bw() + ggtitle("log ADJNSAF values with zeros replaced with 0.1")
```
