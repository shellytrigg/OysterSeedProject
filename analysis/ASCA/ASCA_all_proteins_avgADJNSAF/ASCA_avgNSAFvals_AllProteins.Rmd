...
```{r avgNSAF_PCA_tempEffect_PC2loadings}
...
```{r avgNSAF_tempEffectPC2_cutoff0.025_heatmap_OrderedByTemp_ShortNames,fig.height=10, fig.width=10}
...
#number of proteins affected by time 
nrow(cutd12)
```

Plot a heatmap of proteins affected by time based on time effect PC1 and PC2 loadings value cutoffs 
```{r avgNSAF_timeEffectPC1and2_cutoff0.025_heatmap_OrderedByTime, echo = FALSE, fig.height=10, fig.width=10}
#make a list of cutoff proteins with normalized abundance
...
#number of proteins affected by temp x time interaction
nrow(cutd34)
```
...
```{r avgNSAF_timeXtempEffectPC1and2_cutoff0.025_heatmap_OrderedByTime, echo = FALSE, fig.height=10, fig.width=10}
#make a list of cutoff proteins with normalized abundance
