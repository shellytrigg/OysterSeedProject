...
3. load data with annotations so protein IDs can be substituted with shorter names
```{r, echo =FALSE}
...
4. subset the data for only CHOYP proteins; this removes contaminant proteins
```{r, echo = FALSE}
